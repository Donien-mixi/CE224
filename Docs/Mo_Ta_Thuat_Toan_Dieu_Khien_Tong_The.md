# THUẬT TOÁN ĐIỀU KHIỂN TỔNG THỂ — XE CÂN BẰNG 2 BÁNH TỐC ĐỘ CAO

Đặc tả mô hình toán học động lực học con lắc ngược (TWIP), bộ lọc bù góc nghiêng và giải thuật điều khiển Cascade PID 2 vòng lồng nhau.
...
## 4. MÃ NGUỒN C HIỆN THỰC THỜI GIAN THỰC (200Hz)

Được thực thi trong hàm `Robot_ControlLoop_200Hz()` tại file [`robot_fsm.c`](file:///d:/DA_HTN/Xe_Can_Bang/Core/Src/robot_fsm.c):
